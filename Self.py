...
def help():
    ...
    key = key.title()
    helpMessage = "â¬â¬â¬â¬à®Û©ÛÛ©à®â¬â¬â¬â¬\n" + \
                  "âââ[ Menu hari ini ]\n"+\
                  "ââ¯â¸ " + key + "Me\n" + \
                  "ââ¯â¸ " + key + "Midã@ã\n" + \
                  "ââ¯â¸ " + key + "Infoã@ã\n" + \
                  ...
                  "ââ¯â¸ " + key + "Creator\n" + \
                  "ââ¯â¸ " + key + "Speed/Sp\n" + \
                  "ââ¯â¸ " + key + "Respontime\n" + \
                  "ââ¯â¸ " + key + "Sepinya\n" + \
                  "ââ¯â¸ " + key + "Joinall\n" + \
                  "ââ¯â¸ " + key + "Byeall\n" + \
                  "ââ¯â¸ " + key + "Bye me\n" + \
                  "ââ¯â¸ " + key + "LeaveãNamagrupã\n" + \
                  "ââ¯â¸ " + key + "Ginfo\n" + \
                  "ââ¯â¸ " + key + "Open\n" + \
                  "ââ¯â¸ " + key + "Close\n" + \
                  "ââ¯â¸ " + key + "Url\n" + \
                  "ââ¯â¸ " + key + "Gruplist\n" + \
                  "ââ¯â¸ " + key + "Openãnomerã\n" + \
                  "ââ¯â¸ " + key + "Closeãnomerã\n" + \
                  "ââ¯â¸ " + key + "Infogrupãnomerã\n" + \
                  "ââ¯â¸ " + key + "Infomemãnomerã\n" + \
                  "ââ¯â¸ " + key + "Leaveallãnomerã\n" + \
                  "ââ¯â¸ " + key + "Remove chat\n" + \
                  "ââ¯â¸ " + key + "Lurkingãon/offã\n" + \
                  "ââ¯â¸ " + key + "Lurkers\n" + \
                  "ââ¯â¸ " + key + "Siderãon/offã\n" + \
                  "ââ¯â¸ " + key + "Updatefoto\n" + \
                  "ââ¯â¸ " + key + "Updategrup\n" + \
                  "ââ¯â¸ " + key + "Updatebot\n" + \
                  "ââ¯â¸ " + key + "Broadcast:ãTextã\n" + \
                  "ââ¯â¸ " + key + "SetkeyãNew Keyã\n" + \
                  "ââ¯â¸ " + key + "Mykey\n" + \
                  "ââ¯â¸ " + key + "Resetkey\n" + \
                  "â ââ[ á´á´á´Éªá´ ]\n" + \
                  "ââ¯â¸ " + key + "Kode wilayah\n" + \
                  "ââ¯â¸ " + key + "Listmp3\n" + \
                  "ââ¯â¸ " + key + "Listvideo\n" + \
                  "ââ¯â¸ " + key + "Listimage\n" + \
                  "ââ¯â¸ " + key + "Liststicker\n" + \
                  "ââ¯â¸ " + key + "AddimgãTeksã\n" + \
                  "ââ¯â¸ " + key + "DellimgãTeksã\n" + \
                  "ââ¯â¸ " + key + "Addmp3ãTeksã\n" + \
                  "ââ¯â¸ " + key + "Dellmp3ãTeksã\n" + \
                  "ââ¯â¸ " + key + "AddvideoãTeksã\n" + \
                  "ââ¯â¸ " + key + "DellvideoãTeksã\n" + \
                  "ââ¯â¸ " + key + "AddstickerãTeksã\n" + \
                  "ââ¯â¸ " + key + "DellstickerãTeksã\n" + \
                  "ââ¯â¸ " + key + "Spamtag:ãjumlahnyaã\n" + \
                  "ââ¯â¸ " + key + "Spamtagã@ã\n" + \
                  "ââ¯â¸ " + key + "Spamcall:ãjumlahnyaã\n" + \
                  "ââ¯â¸ " + key + "Spamcall\n" + \
                  "ââ¯â¸ " + key + "Ytmp3:ãJudul Laguã\n" + \
                  "ââ¯â¸ " + key + "Ytmp4:ãJudul Videoã\n" + \
                  "ââ¯â¸ " + key + "MusikãNama Penyanyiã\n" + \
                  "ââ¯â¸ " + key + "Get-fsãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-lineãID Lineã\n" + \
                  "ââ¯â¸ " + key + "Get-apkãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-gifãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-xxxãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-animeãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-mimpiãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-audioãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-mp3ãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-videoãQueryã\n" + \
                  "ââ¯â¸ " + key + "Get-bintangãZodiakã\n" + \
                  "ââ¯â¸ " + key + "Get-zodiakãZodiakã\n" + \
                  "ââ¯â¸ " + key + "Get-sholatãNama Kotaã\n" + \
                  "ââ¯â¸ " + key + "Get-cuacaãNama Kotaã\n" + \
                  "ââ¯â¸ " + key + "Get-lokasiãNama Kotaã\n" + \
                  "ââ¯â¸ " + key + "Get-lirikãJudul Laguã\n" + \
                  "ââ¯â¸ " + key + "Get-instagramãUser Nameã\n" + \
                  "ââ¯â¸ " + key + "Get-dateãtgl-bln-thnã\n" + \
                  "â ââ[ protect ]\n" + \
                  "ââ¯â¸ " + key + "Notagãon/offã\n" + \
                  "ââ¯â¸ " + key + "Allproãon/offã\n" + \
                  "ââ¯â¸ " + key + "Protecturlãon/offã\n" + \
                  "ââ¯â¸ " + key + "Protectjoinãon/offã\n" + \
                  "ââ¯â¸ " + key + "Protectkickãon/offã\n" + \
                  "ââ¯â¸ " + key + "Protectinviteãon/offã\n" + \
                  "ââ¯â¸ " + key + "Protectcancelãon/offã\n" + \
                  "ââ¯â¸ " + key + "Antijsãon/offã\n" + \
                  "ââ¯â¸ " + key + "Ghostãon/offã\n" + \
                  "â ââ[ Set kicker ]\n" + \
                  "ââ¯â¸ " + key + "Kickãon/offã\n" + \
                  "ââ¯â¸ " + key + "Nkã@ã\n" + \
                  "ââ¯â¸ " + key + "Kick1ã@ã\n" + \
                  "â ââ[ Set user ]\n" + \
                  "ââ¯â¸ " + key + "Inviteãon/offã\n" + \
                  "ââ¯â¸ " + key + "Stickerãon/offã\n" + \
                  "ââ¯â¸ " + key + "Unsendãon/offã\n" + \
                  "ââ¯â¸ " + key + "Respontimeãon/offã\n" + \
                  "ââ¯â¸ " + key + "Timelineãon/offã\n" + \
                  "ââ¯â¸ " + key + "Contactãon/offã\n" + \
                  "ââ¯â¸ " + key + "Autojoinãon/offã\n" + \
                  "ââ¯â¸ " + key + "Autoaddãon/offã\n" + \
                  "ââ¯â¸ " + key + "Welcomeãon/offã\n" + \
                  "ââ¯â¸ " + key + "Autoleaveãon/offã\n" + \
                  "ââ¯â¸ " + key + "Jointicketãon/offã\n" + \
                  "â ââ[ Set Admin ]\n" + \
                  "ââ¯â¸ " + key + "Selfãon/offã\n" + \
                  "ââ¯â¸ " + key + "Bot:on\n" + \
                  "ââ¯â¸ " + key + "Bot:expell\n" + \
                  "ââ¯â¸ " + key + "Staff:on\n" + \
                  "ââ¯â¸ " + key + "Staff:expell\n" + \
                  "ââ¯â¸ " + key + "Admin:on\n" + \
                  "ââ¯â¸ " + key + "Admin:expell\n" + \
                  "ââ¯â¸ " + key + "Botaddã@ã\n" + \
                  "ââ¯â¸ " + key + "Botdellã@ã\n" + \
                  "ââ¯â¸ " + key + "Staffaddã@ã\n" + \
                  "ââ¯â¸ " + key + "Staffdellã@ã\n" + \
                  "ââ¯â¸ " + key + "Adminaddã@ã\n" + \
                  "ââ¯â¸ " + key + "Admindellã@ã\n" + \
                  "ââ¯â¸ " + key + "Refresh\n" + \
                  "ââ¯â¸ " + key + "Listbot\n" + \
                  "ââ¯â¸ " + key + "Listadmin\n" + \
                  "ââ¯â¸ " + key + "Listprotect\n" + \
                  "âââ[     Famz_Botz_FI      ]\n" + \
                  "â¬â¬â¬â¬à®Û©ÛÛ©à®â¬â¬â¬â¬\n" + \
                  "\nKetikã Refresh ãjika makanannya sudah habis...\n"
    return helpMessage

def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "â¬â¬â¬â¬à®Û©ÛÛ©à®â¬â¬â¬â¬\n" + \
                  "âââ[ Makan__Malam ]\n"+\
                  "ââ¯â¸ " + key + "Blc\n" + \
                  "ââ¯â¸ " + key + "Ban:on\n" + \
                  "ââ¯â¸ " + key + "Unban:on\n" + \
                  "ââ¯â¸ " + key + "Banã@ã\n" + \
                  "ââ¯â¸ " + key + "Unbanã@ã\n" + \
                  "ââ¯â¸ " + key + "Talkbanã@ã\n" + \
                  "ââ¯â¸ " + key + "Untalkbanã@ã\n" + \
                  ...
                  "ââ¯â¸ " + key + "Set sider:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Set spam:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Set pesan:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Set respon:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Set leave:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Set welcome:ãTextã\n" + \
                  "ââ¯â¸ " + key + "Myname:ãNamaã\n" + \
                  "ââ¯â¸ " + key + "Gift:ãMid korbanããJumlahã\n" + \
                  "ââ¯â¸ " + key + "Spam:ãMid korbanããJumlahã\n" + \
                  "âââ[     Famz_Botz_FI      ]\n" + \
                  "â¬â¬â¬â¬à®Û©ÛÛ©à®â¬â¬â¬â¬\n" + \
                  "\nKetikã Refresh ãjika makannya sudah kenyang...\n"
    return helpMessage1
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if msg.to in protectinvite: md+="â§ProtectinviteãONã\n"
                                else: md+="â§ProtectinviteãOFFã\n"
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator âââââ¦Bardi_Ud0â§ââââº") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"âââââ¦Daftar__Adminâ§ââââº \n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotalã%sã Anggota" %(str(len(owner)+len(admin)+len(staff))))
